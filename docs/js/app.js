  ...
  "components": {
    "schemas": {
      "metadata-values": {
            ...
            "oneOf": [
              ...
              },
              {
                ...
                "properties": {
                  ...
                  "options": {
                    "type": "array",
                    "description": "Each option specifies one button placed on the image.",
                    "items": {
                      "type": "object",
                      "properties": {
                        "positionX": {
                          "type": "integer",
                          "description": "X value as percentage on horizontal axis. 0 => on left border",
                          "x-parser-schema-id": "<anonymous-schema-40>"
                        },
                        "positionY": {
                          "type": "integer",
                          "description": "Y value as percentage on vertical axis. 0 => on top border",
                          "x-parser-schema-id": "<anonymous-schema-41>"
                        },
                        "size": {
                          "type": "string",
                          "description": "every button can vary in size",
                          "enum": [
                            "SMALL",
                            "MEDIUM",
                            "LARGE"
        ...
        "definitions": {
          "option": "$ref:$.components.schemas.metadata-values.properties.interactionParameters.oneOf[0].properties.options.items",
          "repeatButton": "$ref:$.components.schemas.metadata-values.properties.interactionParameters.oneOf[4].properties.options.oneOf[1].properties.repeatButton",
          ...
          "findOnImageOption": "$ref:$.components.schemas.metadata-values.properties.interactionParameters.oneOf[2].properties.options.items",
        ...
        "x-parser-schema-id": "stars-unit-definition@0.13"
      }
    }
  },
